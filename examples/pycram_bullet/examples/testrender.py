...
if 1:
  ...
  if (egl):
    pluginId = pycram_bullet.loadPlugin(egl.get_filename(), "_eglRendererPlugin")
  else:
    pluginId = pycram_bullet.loadPlugin("eglRendererPlugin")
  print("pluginId=",pluginId)

pycram_bullet.setAdditionalSearchPath(pycram_bullet_data.getDataPath())

#pycram_bullet.loadPlugin("eglRendererPlugin")
usePlane = False
