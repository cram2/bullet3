...
path = pycram_bullet_data.getDataPath() + "/data/motions/humanoid3d_backflip.txt"
#path	=	pycram_bullet_data.getDataPath()+"/data/motions/humanoid3d_cartwheel.txt"
#path	=	pycram_bullet_data.getDataPath()+"/data/motions/humanoid3d_walk.txt"
