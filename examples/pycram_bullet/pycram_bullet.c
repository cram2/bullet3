...
static double pycram_bullet_internalGetFloatFromSequence(PyObject* seq, int index)
{
	double v = 0.0;
	PyObject* item;
...
static int pycram_bullet_internalGetIntFromSequence(PyObject* seq, int index)
{
	int v = 0;
	PyObject* item;
...
static const char* pycram_bullet_internalGetCStringFromSequence(PyObject* seq, int index)
{
	const char* v = 0;
	PyObject* item;
...
static int pycram_bullet_internalSetMatrix(PyObject* objMat, float matrix[16])
{
	int i, len;
	PyObject* seq;
	...
	if (seq)
	{
		...
		if (len == 16)
		{
			for (i = 0; i < len; i++)
			{
				matrix[i] = pycram_bullet_internalGetFloatFromSequence(seq, i);
			}
			Py_DECREF(seq);
			return 1;
		}
...
static int pycram_bullet_internalSetVector(PyObject* objVec, float vector[3])
{
	int i, len;
	PyObject* seq = 0;
	...
	if (seq)
	{
		...
		if (len == 3)
		{
			for (i = 0; i < len; i++)
			{
				vector[i] = pycram_bullet_internalGetFloatFromSequence(seq, i);
			}
			Py_DECREF(seq);
			return 1;
		}
...
static int pycram_bullet_internalSetVector2d(PyObject* obVec, double vector[2])
{
	int i, len;
	PyObject* seq;
	if (obVec == NULL)
...
static int pycram_bullet_internalSetVectord(PyObject* obVec, double vector[3])
{
	int i, len;
	PyObject* seq;
	if (obVec == NULL)
...
static int pycram_bullet_internalSetVector4d(PyObject* obVec, double vector[4])
{
	int i, len;
	PyObject* seq;
	if (obVec == NULL)
...
static int pycram_bullet_internalGetVector3FromSequence(PyObject* seq, int index, double vec[3])
{
	int v = 0;
	PyObject* item;
	...
	{
		item = PyList_GET_ITEM(seq, index);
		pycram_bullet_internalSetVectord(item, vec);
	}
	else
	{
		item = PyTuple_GET_ITEM(seq, index);
...
static int pycram_bullet_internalGetVector4FromSequence(PyObject* seq, int index, double vec[4])
{
	int v = 0;
	PyObject* item;
	...
	{
		item = PyList_GET_ITEM(seq, index);
		pycram_bullet_internalSetVector4d(item, vec);
	}
	else
	{
		item = PyTuple_GET_ITEM(seq, index);
...
static PyObject* pycram_bullet_stepSimulation(PyObject* self, PyObject* args, PyObject* keywds)
{
...
static PyObject* pycram_bullet_performCollisionDetection(PyObject* self, PyObject* args, PyObject* keywds)
{
	int physicsClientId = 0;
	static char* kwlist[] = {"physicsClientId", NULL};
	b3PhysicsClientHandle sm = 0;
...
static PyObject* pycram_bullet_connectPhysicsServer(PyObject* self, PyObject* args, PyObject* keywds)
{
	int freeIndex = -1;
...
#else
				PyErr_SetString(SpamError, "TCP is not enabled in this pycram_bullet build");
				return NULL;
#endif//BT_ENABLE_CLSOCKET
				break;
			}
...
#else
				PyErr_SetString(SpamError, "GRPC is not enabled in this pycram_bullet build");
#endif
				break;
			}
...
#else
				PyErr_SetString(SpamError, "UDP is not enabled in this pycram_bullet build");
				return NULL;
#endif  //BT_ENABLE_ENET
...
static PyObject* pycram_bullet_disconnectPhysicsServer(PyObject* self,
												  PyObject* args,
												  PyObject* keywds)
{
	int physicsClientId = 0;
...
void b3pycram_bulletExitFunc(void)
{
	int i;
	for (i = 0; i < MAX_PHYSICS_CLIENTS; i++)
	{
...
static PyObject* pycram_bullet_isConnected(PyObject* self, PyObject* args, PyObject* keywds)
{
	int physicsClientId = 0;
	int isConnected = 0;
	int method = 0;
...
static PyObject* pycram_bullet_getConnectionInfo(PyObject* self, PyObject* args, PyObject* keywds)
{
	int physicsClientId = 0;
	int isConnected = 0;
	int method = 0;
...
static PyObject* pycram_bullet_syncBodyInfo(PyObject* self, PyObject* args, PyObject* keywds)
{
	b3PhysicsClientHandle sm = 0;
	int physicsClientId = 0;
	static char* kwlist[] = {"physicsClientId", NULL};
...
static PyObject* pycram_bullet_syncUserData(PyObject* self, PyObject* args, PyObject* keywds)
{
	b3PhysicsClientHandle sm = 0;
	int physicsClientId = 0;
	...
	if (bodyUniqueIdsObj)
	{
		...
		for (i=0; i < len; ++i)
		{
			b3AddBodyToSyncUserDataRequest(command, pycram_bullet_internalGetIntFromSequence(seq, i));
		}
	}
...
static PyObject* pycram_bullet_addUserData(PyObject* self, PyObject* args, PyObject* keywds)
{
	b3PhysicsClientHandle sm = 0;
	int physicsClientId = 0;
	int bodyUniqueId = -1;
...
static PyObject* pycram_bullet_removeUserData(PyObject* self, PyObject* args, PyObject* keywds)
{
	b3PhysicsClientHandle sm = 0;
	int physicsClientId = 0;
	int userDataId = -1;
...
static PyObject* pycram_bullet_getUserDataId(PyObject* self, PyObject* args, PyObject* keywds)
{
	b3PhysicsClientHandle sm = 0;
	int physicsClientId = 0;
	int bodyUniqueId = -1;
...
static PyObject* pycram_bullet_getUserData(PyObject* self, PyObject* args, PyObject* keywds)
{
	b3PhysicsClientHandle sm = 0;
	int physicsClientId = 0;
	int userDataId = -1;
...
static PyObject* pycram_bullet_getNumUserData(PyObject* self, PyObject* args, PyObject* keywds)
{
	b3PhysicsClientHandle sm = 0;
	int physicsClientId = 0;
	int bodyUniqueId = -1;
...
static PyObject* pycram_bullet_getUserDataInfo(PyObject* self, PyObject* args, PyObject* keywds)
{
	b3PhysicsClientHandle sm = 0;
	int physicsClientId = 0;
	int bodyUniqueId = -1;
...
static PyObject* pycram_bullet_saveWorld(PyObject* self, PyObject* args, PyObject* keywds)
{
...
static PyObject* pycram_bullet_loadBullet(PyObject* self, PyObject* args, PyObject* keywds)
{
...
static PyObject* pycram_bullet_saveBullet(PyObject* self, PyObject* args, PyObject* keywds)
{
	const char* bulletFileName = "";
	b3SharedMemoryStatusHandle statusHandle;
	int statusType;
...
static PyObject* pycram_bullet_restoreState(PyObject* self, PyObject* args, PyObject* keywds)
{
	const char* fileName = "";
	b3SharedMemoryStatusHandle statusHandle;
	int statusType;
...
static PyObject* pycram_bullet_saveState(PyObject* self, PyObject* args, PyObject* keywds)
{
	b3SharedMemoryStatusHandle statusHandle;
	int statusType;
	b3SharedMemoryCommandHandle command;
...
static PyObject* pycram_bullet_removeState(PyObject* self, PyObject* args, PyObject* keywds)
{
	{
		int stateUniqueId = -1;
		b3PhysicsClientHandle sm = 0;
...
static PyObject* pycram_bullet_loadMJCF(PyObject* self, PyObject* args, PyObject* keywds)
{
...
static PyObject* pycram_bullet_changeDynamicsInfo(PyObject* self, PyObject* args, PyObject* keywds)
{
	int bodyUniqueId = -1;
	int linkIndex = -2;
	double mass = -1;
...

	{
		...
		if (localInertiaDiagonalObj)
		{
			...
			pycram_bullet_internalSetVectord(localInertiaDiagonalObj, localInertiaDiagonal);
...
static PyObject* pycram_bullet_getDynamicsInfo(PyObject* self, PyObject* args, PyObject* keywds)
{
	{
		int bodyUniqueId = -1;
		int linkIndex = -2;
...
static PyObject* pycram_bullet_getPhysicsEngineParameters(PyObject* self, PyObject* args, PyObject* keywds)
{
	b3PhysicsClientHandle sm = 0;
	PyObject* val = 0;
	int physicsClientId = 0;
...
static PyObject* pycram_bullet_setPhysicsEngineParameter(PyObject* self, PyObject* args, PyObject* keywds)
{
...
static PyObject* pycram_bullet_loadURDF(PyObject* self, PyObject* args, PyObject* keywds)
{
	int physicsClientId = 0;
	int flags = 0;
	...
	if (!backwardsCompatibilityArgs)
	{
		...
		else
		{
			if (basePosObj)
			{
				if (!pycram_bullet_internalSetVectord(basePosObj, basePos))
				{
			...
			if (baseOrnObj)
			{
				if (!pycram_bullet_internalSetVector4d(baseOrnObj, baseOrn))
				{
...
static PyObject* pycram_bullet_loadSDF(PyObject* self, PyObject* args, PyObject* keywds)
{
...
static PyObject* pycram_bullet_loadSoftBody(PyObject* self, PyObject* args, PyObject* keywds)
{
	int physicsClientId = 0;
	int flags = 0;
	...
	else
	{
		if (basePosObj)
		{
			if (!pycram_bullet_internalSetVectord(basePosObj, startPos))
			{
				PyErr_SetString(SpamError, "Cannot convert basePosition.");
				return NULL;
			}
		...
		if (baseOrnObj)
		{
			if (!pycram_bullet_internalSetVector4d(baseOrnObj, startOrn))
			{
				PyErr_SetString(SpamError, "Cannot convert baseOrientation.");
				return NULL;
			}
...
static PyObject* pycram_bullet_createSoftBodyAnchor(PyObject* self, PyObject* args, PyObject* keywds)
{
	b3SharedMemoryCommandHandle commandHandle;
	...
	pycram_bullet_internalSetVectord(bodyFramePositionObj, bodyFramePosition);
...
static PyObject* pycram_bullet_resetSimulation(PyObject* self, PyObject* args, PyObject* keywds)
{
	int physicsClientId = 0;
	int flags = 0;
...
//this method is obsolete, use pycram_bullet_setJointMotorControl2 instead
static PyObject* pycram_bullet_setJointMotorControl(PyObject* self, PyObject* args)
{
	int size;
...
static PyObject* pycram_bullet_setJointMotorControlArray(PyObject* self, PyObject* args, PyObject* keywds)
{
...

	{
...

		{
			...
			{
				int jointIndex = pycram_bullet_internalGetIntFromSequence(jointIndicesSeq, i);
				if ((jointIndex >= numJoints) || (jointIndex < 0))
				{
					Py_DECREF(jointIndicesSeq);
					PyErr_SetString(SpamError, "Joint index out-of-range.");
		...
		for (i = 0; i < numControlledDofs; i++)
		{
			...
			if (targetVelocitiesSeq)
			{
				targetVelocity = pycram_bullet_internalGetFloatFromSequence(targetVelocitiesSeq, i);
			}

			if (targetPositionsSeq)
			{
				targetPosition = pycram_bullet_internalGetFloatFromSequence(targetPositionsSeq, i);
			}

			if (forcesSeq)
			{
				force = pycram_bullet_internalGetFloatFromSequence(forcesSeq, i);
			}

			if (kpsSeq)
			{
				kp = pycram_bullet_internalGetFloatFromSequence(kpsSeq, i);
			}

			if (kdsSeq)
			{
				kd = pycram_bullet_internalGetFloatFromSequence(kdsSeq, i);
			}

			jointIndex = pycram_bullet_internalGetFloatFromSequence(jointIndicesSeq, i);
			b3GetJointInfo(sm, bodyUniqueId, jointIndex, &info);
...
static PyObject* pycram_bullet_setJointMotorControlMultiDofArray(PyObject* self, PyObject* args, PyObject* keywds)
{
	int bodyUniqueId, controlMode;
...

	{
		...
		for (j = 0; j < numControlledDofs; j++)
		{
			...
			int jointIndex = pycram_bullet_internalGetIntFromSequence(jointIndicesSeq, j); 
			if ((jointIndex >= numJoints) || (jointIndex < 0))
			{
				Py_DECREF(jointIndicesSeq);
				PyErr_SetString(SpamError, "Joint index out-of-range.");
			...
			if (numKps > 0)
			{
				kp = pycram_bullet_internalGetFloatFromSequence(kpsSeq, j);
			}
			if (numKds>0)
			{
				kd = pycram_bullet_internalGetFloatFromSequence(kdsSeq, j);
			}
			...
			if (targetPositionObj)
			{
				...
				if (targetPositionSeq)
				{
					...
					{
						targetPositionArray[i] = pycram_bullet_internalGetFloatFromSequence(targetPositionSeq, i);
					}
			...
			if (targetVelocityObj)
			{
				...
				if (targetVelocitySeq)
				{
					...
					{
						targetVelocityArray[i] = pycram_bullet_internalGetFloatFromSequence(targetVelocitySeq, i);
					}
			...
			if (targetForceObj)
			{
				...
				if (targetForceSeq)
				{
					...
					{
						targetForceArray[i] = pycram_bullet_internalGetFloatFromSequence(targetForceSeq, i);
					}
...
static PyObject* pycram_bullet_setJointMotorControlMultiDof(PyObject* self, PyObject* args, PyObject* keywds)
{
	int bodyUniqueId, jointIndex, controlMode;
	...
	if (kpObj)
	{
		...
		if (kpSeq)
		{
			for (i = 0; i < kpSize; i++)
			{
				kpArray[i] = pycram_bullet_internalGetFloatFromSequence(kpSeq, i);
			}
			Py_DECREF(kpSeq);
		}
	}
	...
	if (kdObj)
	{
		...
		if (kdSeq)
		{
			for (i = 0; i < kdSize; i++)
			{
				kdArray[i] = pycram_bullet_internalGetFloatFromSequence(kdSeq, i);
			}
			Py_DECREF(kdSeq);
		}
	}
	...
	if (dampingObj)
	{
		...
		if (dampingSeq)
		{
			...
			{
				dampingArray[i] = pycram_bullet_internalGetFloatFromSequence(dampingSeq, i);
			}
...
static PyObject* pycram_bullet_setJointMotorControl2(PyObject* self, PyObject* args, PyObject* keywds)
{
	int bodyUniqueId, jointIndex, controlMode;
...
static PyObject* pycram_bullet_setRealTimeSimulation(PyObject* self,
												PyObject* args,
												PyObject* keywds)
{
...
static PyObject* pycram_bullet_setInternalSimFlags(PyObject* self,
...
static PyObject* pycram_bullet_setGravity(PyObject* self, PyObject* args, PyObject* keywds)
{
	{
		double gravX = 0.0;
		double gravY = 0.0;
...
static PyObject* pycram_bullet_setTimeStep(PyObject* self, PyObject* args, PyObject* keywds)
{
...
static PyObject*
pycram_bullet_setDefaultContactERP(PyObject* self, PyObject* args, PyObject* keywds)
{
...
static int pycram_bullet_internalGetBaseVelocity(
...
static PyObject* pycram_bullet_getAABB(PyObject* self, PyObject* args, PyObject* keywds)
{
	int bodyUniqueId = -1;
	int linkIndex = -1;
...
static PyObject* pycram_bullet_getBasePositionAndOrientation(PyObject* self,
														PyObject* args, PyObject* keywds)
{
	int bodyUniqueId = -1;
	...
	if (0 == pycram_bullet_internalGetBasePositionAndOrientation(
...
static PyObject* pycram_bullet_getBaseVelocity(PyObject* self,
										  PyObject* args, PyObject* keywds)
{
	int bodyUniqueId = -1;
...
static PyObject* pycram_bullet_getNumBodies(PyObject* self, PyObject* args, PyObject* keywds)
{
	int physicsClientId = 0;
	b3PhysicsClientHandle sm = 0;
...
static PyObject* pycram_bullet_computeDofCount(PyObject* self, PyObject* args, PyObject* keywds)
{
	int physicsClientId = 0;
	int bodyUniqueId = -1;
	b3PhysicsClientHandle sm = 0;
...
static PyObject* pycram_bullet_getBodyUniqueId(PyObject* self, PyObject* args, PyObject* keywds)
{
	int physicsClientId = 0;
	int serialIndex = -1;
	b3PhysicsClientHandle sm = 0;
...
static PyObject* pycram_bullet_removeCollisionShape(PyObject* self, PyObject* args, PyObject* keywds)
{
	{
...
static PyObject* pycram_bullet_removeBody(PyObject* self, PyObject* args, PyObject* keywds)
{
	{
		int bodyUniqueId = -1;
		b3PhysicsClientHandle sm = 0;
...
static PyObject* pycram_bullet_getBodyInfo(PyObject* self, PyObject* args, PyObject* keywds)
{
	{
		int bodyUniqueId = -1;
		b3PhysicsClientHandle sm = 0;
...
static PyObject* pycram_bullet_getConstraintInfo(PyObject* self, PyObject* args, PyObject* keywds)
{
	{
...
static PyObject* pycram_bullet_getConstraintState(PyObject* self, PyObject* args, PyObject* keywds)
{
	{
		int constraintUniqueId = -1;
		b3PhysicsClientHandle sm = 0;
...
static PyObject* pycram_bullet_getConstraintUniqueId(PyObject* self, PyObject* args, PyObject* keywds)
{
	int physicsClientId = 0;
	int serialIndex = -1;
	b3PhysicsClientHandle sm = 0;
...
static PyObject* pycram_bullet_getNumConstraints(PyObject* self, PyObject* args, PyObject* keywds)
{
...
static PyObject* pycram_bullet_getAPIVersion(PyObject* self, PyObject* args, PyObject* keywds)
{
	int physicsClientId = 0;
	b3PhysicsClientHandle sm = 0;
	static char* kwlist[] = {"physicsClientId", NULL};
...
// body index; body index is based on order of sequence
// the object is loaded into simulation
static PyObject* pycram_bullet_getNumJoints(PyObject* self, PyObject* args, PyObject* keywds)
{
	int bodyUniqueId = -1;
	int numJoints = 0;
	int physicsClientId = 0;
...
static PyObject* pycram_bullet_resetJointState(PyObject* self, PyObject* args, PyObject* keywds)
{
	{
		int bodyUniqueId;
		int jointIndex;
...
// Initalize all joint positions given a list of values
static PyObject* pycram_bullet_resetJointStatesMultiDof(PyObject* self, PyObject* args, PyObject* keywds)
{
	{
		b3PhysicsClientHandle sm = 0;
		int bodyUniqueId;
...
// Initalize all joint positions given a list of values
static PyObject* pycram_bullet_resetJointStateMultiDof(PyObject* self, PyObject* args, PyObject* keywds)
{
	{
		b3PhysicsClientHandle sm = 0;
		int bodyUniqueId;
...
static PyObject* pycram_bullet_resetBaseVelocity(PyObject* self, PyObject* args, PyObject* keywds)
{
...

	{
		...
		if (linVelObj || angVelObj)
		{
			...
			if (linVelObj)
			{
				pycram_bullet_internalSetVectord(linVelObj, linVel);
				b3CreatePoseCommandSetBaseLinearVelocity(commandHandle, linVel);
			}

			if (angVelObj)
			{
				pycram_bullet_internalSetVectord(angVelObj, angVel);
...
static PyObject* pycram_bullet_resetBasePositionAndOrientation(PyObject* self,
														  PyObject* args, PyObject* keywds)
{
	{
		int bodyUniqueId;
...

		{
...

			{
				...
				if (len == 3)
				{
					for (i = 0; i < 3; i++)
					{
						pos[i] = pycram_bullet_internalGetFloatFromSequence(seq, i);
					}
				}
				else
				{
...

			{
				...
				if (len == 4)
				{
					for (i = 0; i < 4; i++)
					{
						orn[i] = pycram_bullet_internalGetFloatFromSequence(seq, i);
					}
				}
				else
				{
...
static PyObject* pycram_bullet_changeScaling(PyObject* self,
	PyObject* args, PyObject* keywds)
{
	{
		int bodyUniqueId;
...

		{
...

			{
				...
				if (len == 3)
				{
					for (i = 0; i < 3; i++)
					{
						scaling[i] = pycram_bullet_internalGetFloatFromSequence(seq, i);
					}
				}
				else
				{
...
static PyObject* pycram_bullet_getJointInfo(PyObject* self, PyObject* args, PyObject* keywds)
{
...
static PyObject* pycram_bullet_getJointState(PyObject* self, PyObject* args, PyObject* keywds)
{
...
static PyObject* pycram_bullet_getJointStateMultiDof(PyObject* self, PyObject* args, PyObject* keywds)
{
	PyObject* pyListJointForceTorque;
	PyObject* pyListJointState;
...
static PyObject* pycram_bullet_getJointStatesMultiDof(PyObject* self, PyObject* args, PyObject* keywds)
{
	PyObject* pyListPosition;
	PyObject* pyListVelocity;
	PyObject* pyListJointMotorTorque;
	...
	{
		{
...

			{
				...
				for (jnt = 0; jnt < numRequestedJoints; jnt++)
				{
					PyObject* pyListJointForceTorque;
					PyObject* pyListJointState;
					int jointIndex = pycram_bullet_internalGetFloatFromSequence(jointIndicesSeq, jnt);
...
static PyObject* pycram_bullet_getJointStates(PyObject* self, PyObject* args, PyObject* keywds)
{
	PyObject* pyListJointForceTorque;
	PyObject* pyListJointState;
	PyObject* jointIndicesObj = 0;
	...
	{
		{
			...
			{
				int jointIndex = pycram_bullet_internalGetFloatFromSequence(jointIndicesSeq, i);
				if ((jointIndex >= numJoints) || (jointIndex < 0))
				{
					Py_DECREF(jointIndicesSeq);
					PyErr_SetString(SpamError, "Joint index out-of-range.");
...
static PyObject* pycram_bullet_getLinkState(PyObject* self, PyObject* args, PyObject* keywds)
{
...
static PyObject* pycram_bullet_getLinkStates(PyObject* self, PyObject* args, PyObject* keywds)
{
	PyObject* pyLinkState;
	PyObject* pyLinkStateWorldPosition;
	PyObject* pyLinkStateWorldOrientation;
	...
	{
		{
			...
			{
				int linkIndex = pycram_bullet_internalGetIntFromSequence(linkIndicesSeq, link);
...
static PyObject* pycram_bullet_readUserDebugParameter(PyObject* self, PyObject* args, PyObject* keywds)
{
	b3SharedMemoryCommandHandle commandHandle;
	b3SharedMemoryStatusHandle statusHandle;
	int statusType;
...
static PyObject* pycram_bullet_addUserDebugParameter(PyObject* self, PyObject* args, PyObject* keywds)
{
	b3SharedMemoryCommandHandle commandHandle;
	b3SharedMemoryStatusHandle statusHandle;
	int statusType;
...
static PyObject* pycram_bullet_addUserDebugText(PyObject* self, PyObject* args, PyObject* keywds)
{
	b3SharedMemoryCommandHandle commandHandle;
	b3SharedMemoryStatusHandle statusHandle;
	int statusType;
	...
	res = pycram_bullet_internalSetVectord(textPositionObj, posXYZ);
	if (!res)
	{
	...
	if (textColorRGBObj)
	{
		res = pycram_bullet_internalSetVectord(textColorRGBObj, colorRGB);
		if (!res)
		{
	...
	{
		res = pycram_bullet_internalSetVector4d(textOrientationObj, textOrientation);
		if (!res)
		{
...
static PyObject* pycram_bullet_addUserDebugLine(PyObject* self, PyObject* args, PyObject* keywds)
{
	b3SharedMemoryCommandHandle commandHandle;
	b3SharedMemoryStatusHandle statusHandle;
	int statusType;
	...
	res = pycram_bullet_internalSetVectord(lineFromObj, fromXYZ);
	if (!res)
	{
	...
	res = pycram_bullet_internalSetVectord(lineToObj, toXYZ);
	if (!res)
	{
	...
	if (lineColorRGBObj)
	{
		res = pycram_bullet_internalSetVectord(lineColorRGBObj, colorRGB);
	}
		...
		if (seqVerticesObj)
		{
			int numVerticesSrc = PySequence_Size(seqVerticesObj);
			{
				...
				for (i = 0; i < numVerticesSrc; i++)
				{
					...
					double vertex[3];
					if (pycram_bullet_internalSetVectord(vertexObj, vertex))
					{
						if (vertices)
						{
...
static PyObject* pycram_bullet_addUserDebugPoints(PyObject* self, PyObject* args, PyObject* keywds)
{
	b3SharedMemoryCommandHandle commandHandle;
	b3SharedMemoryStatusHandle statusHandle;
	int statusType;
...
static PyObject* pycram_bullet_removeUserDebugItem(PyObject* self, PyObject* args, PyObject* keywds)
{
	b3SharedMemoryCommandHandle commandHandle;
	b3SharedMemoryStatusHandle statusHandle;
	int statusType;
...
static PyObject* pycram_bullet_removeAllUserDebugItems(PyObject* self, PyObject* args, PyObject* keywds)
{
	b3SharedMemoryCommandHandle commandHandle;
	b3SharedMemoryStatusHandle statusHandle;
	int statusType;
...
static PyObject* pycram_bullet_removeAllUserParameters(PyObject* self, PyObject* args, PyObject* keywds)
{
	b3SharedMemoryCommandHandle commandHandle;
	b3SharedMemoryStatusHandle statusHandle;
	int statusType;
...
static PyObject* pycram_bullet_startStateLogging(PyObject* self, PyObject* args, PyObject* keywds)
{
	b3SharedMemoryStatusHandle statusHandle;
	int statusType;
	...
	}
	{
		...
		if (objectUniqueIdsObj)
		{
			...
			if (seq)
			{
				...
				for (i = 0; i < len; i++)
				{
					int objectUid = pycram_bullet_internalGetFloatFromSequence(seq, i);
...
static PyObject* pycram_bullet_submitProfileTiming(PyObject* self, PyObject* args, PyObject* keywds)
{
	//	b3SharedMemoryStatusHandle statusHandle;
	//	int statusType;
	char* eventName = 0;
...
static PyObject* pycram_bullet_stopStateLogging(PyObject* self, PyObject* args, PyObject* keywds)
{
	b3SharedMemoryStatusHandle statusHandle;
	int statusType;
	int loggingId = -1;
...
static PyObject* pycram_bullet_setAdditionalSearchPath(PyObject* self, PyObject* args, PyObject* keywds)
{
...
static PyObject* pycram_bullet_vhacd(PyObject* self, PyObject* args, PyObject* keywds)
{
	char* fileNameIn = 0;
	char* fileNameOut = 0;
...
static PyObject* pycram_bullet_setTimeOut(PyObject* self, PyObject* args, PyObject* keywds)
{
...
static PyObject* pycram_bullet_rayTestObsolete(PyObject* self, PyObject* args, PyObject* keywds)
{
	b3SharedMemoryCommandHandle commandHandle;
	b3SharedMemoryStatusHandle statusHandle;
	int statusType;
	...
	pycram_bullet_internalSetVectord(rayFromObj, from);
	pycram_bullet_internalSetVectord(rayToObj, to);
...
static PyObject* pycram_bullet_rayTestBatch(PyObject* self, PyObject* args, PyObject* keywds)
{
	b3SharedMemoryCommandHandle commandHandle;
	b3SharedMemoryStatusHandle statusHandle;
	int statusType;
		...
		if (seqRayFromObj && seqRayToObj)
		{
			...
			else
			{
				...
				for (i = 0; i < lenFrom; i++)
				{
					...
					if ((pycram_bullet_internalSetVectord(rayFromObj, rayFromWorld)) &&
						(pycram_bullet_internalSetVectord(rayToObj, rayToWorld)))
					{
...
static PyObject* pycram_bullet_getMatrixFromQuaternion(PyObject* self, PyObject* args, PyObject* keywds)
{
	PyObject* quatObj;
	double quat[4];
	int physicsClientId = 0;
	...
	if (quatObj)
	{
		if (pycram_bullet_internalSetVector4d(quatObj, quat))
		{
...
static PyObject* pycram_bullet_setVRCameraState(PyObject* self, PyObject* args, PyObject* keywds)
{
	b3SharedMemoryCommandHandle commandHandle;
	b3SharedMemoryStatusHandle statusHandle;
	int statusType;
	...
	if (pycram_bullet_internalSetVectord(rootPosObj, rootPos))
	{
		b3SetVRCameraRootPosition(commandHandle, rootPos);
	}
	if (pycram_bullet_internalSetVector4d(rootOrnObj, rootOrn))
	{
...
static PyObject* pycram_bullet_getKeyboardEvents(PyObject* self, PyObject* args, PyObject* keywds)
{
	b3SharedMemoryCommandHandle commandHandle;
	int physicsClientId = 0;
	b3PhysicsClientHandle sm = 0;
...
static PyObject* pycram_bullet_getMouseEvents(PyObject* self, PyObject* args, PyObject* keywds)
{
	b3SharedMemoryCommandHandle commandHandle;
	int physicsClientId = 0;
	b3PhysicsClientHandle sm = 0;
...
static PyObject* pycram_bullet_getVREvents(PyObject* self, PyObject* args, PyObject* keywds)
{
	b3SharedMemoryCommandHandle commandHandle;
	b3SharedMemoryStatusHandle statusHandle;
	int statusType;
...
static PyObject* pycram_bullet_getDebugVisualizerCamera(PyObject* self, PyObject* args, PyObject* keywds)
{
	int physicsClientId = 0;
	b3PhysicsClientHandle sm = 0;
	static char* kwlist[] = {"physicsClientId", NULL};
...
static PyObject* pycram_bullet_configureDebugVisualizer(PyObject* self, PyObject* args, PyObject* keywds)
{
	int flag = -1;
	int enable = -1;
...

	{
		...
		if (pyLightPosition)
		{
			...
			if (pycram_bullet_internalSetVector(pyLightPosition, lightPosition))
			{
		...
		if (pyRgbBackground)
		{
			...
			if (pycram_bullet_internalSetVector(pyRgbBackground, rgbBackground))
			{
...
static PyObject* pycram_bullet_resetDebugVisualizerCamera(PyObject* self, PyObject* args, PyObject* keywds)
{
...

	{
		...
		if ((cameraDistance >= 0))
		{
			...
			if (pycram_bullet_internalSetVector(cameraTargetPosObj, cameraTargetPosition))
			{
...
static PyObject* pycram_bullet_setDebugObjectColor(PyObject* self, PyObject* args, PyObject* keywds)
{
	...
	{
		if (pycram_bullet_internalSetVectord(objectColorRGBObj, objectColorRGB))
		{
...
static PyObject* pycram_bullet_getCollisionShapeData(PyObject* self, PyObject* args, PyObject* keywds)
{
	int objectUniqueId = -1;
	b3SharedMemoryCommandHandle commandHandle;
	b3SharedMemoryStatusHandle statusHandle;
...
static PyObject* pycram_bullet_getVisualShapeData(PyObject* self, PyObject* args, PyObject* keywds)
{
	int objectUniqueId = -1;
	b3SharedMemoryCommandHandle commandHandle;
	b3SharedMemoryStatusHandle statusHandle;
...
static PyObject* pycram_bullet_changeVisualShape(PyObject* self, PyObject* args, PyObject* keywds)
{
	int objectUniqueId = -1;
	int jointIndex = -1;
	int shapeIndex = -1;
...

	{
		...
		if (specularColorObj)
		{
			...
			pycram_bullet_internalSetVectord(specularColorObj, specularColor);
		...
		if (rgbaColorObj)
		{
			...
			pycram_bullet_internalSetVector4d(rgbaColorObj, rgbaColor);
...
static PyObject* pycram_bullet_changeTexture(PyObject* self, PyObject* args, PyObject* keywds)
{
...
static PyObject* pycram_bullet_loadTexture(PyObject* self, PyObject* args, PyObject* keywds)
{
...
static PyObject* pycram_bullet_setCollisionFilterGroupMask(PyObject* self, PyObject* args, PyObject* keywds)
{
	int physicsClientId = 0;
	b3PhysicsClientHandle sm = 0;
	int bodyUniqueIdA = -1;
...
static PyObject* pycram_bullet_setCollisionFilterPair(PyObject* self, PyObject* args, PyObject* keywds)
{
	int physicsClientId = 0;
	b3PhysicsClientHandle sm = 0;
	int bodyUniqueIdA = -1;
...
static PyObject* pycram_bullet_getOverlappingObjects(PyObject* self, PyObject* args, PyObject* keywds)
{
	...
	pycram_bullet_internalSetVectord(aabbMinOb, aabbMin);
	pycram_bullet_internalSetVectord(aabbMaxOb, aabbMax);
...
static PyObject* pycram_bullet_getClosestPointData(PyObject* self, PyObject* args, PyObject* keywds)
{
	int bodyUniqueIdA = -1;
	int bodyUniqueIdB = -1;
	int linkIndexA = -2;
	...
	{
		pycram_bullet_internalSetVectord(collisionShapePositionAObj, collisionShapePositionA);
		b3SetClosestDistanceFilterCollisionShapePositionA(commandHandle, collisionShapePositionA);
	}
	if (collisionShapePositionBObj)
	{
		pycram_bullet_internalSetVectord(collisionShapePositionBObj, collisionShapePositionB);
		b3SetClosestDistanceFilterCollisionShapePositionB(commandHandle, collisionShapePositionB);
	}
	if (collisionShapeOrientationAObj)
	{
		pycram_bullet_internalSetVector4d(collisionShapeOrientationAObj, collisionShapeOrientationA);
...
static PyObject* pycram_bullet_changeUserConstraint(PyObject* self, PyObject* args, PyObject* keywds)
{
	...
	if (pycram_bullet_internalSetVectord(jointChildPivotObj, jointChildPivot))
	{
		b3InitChangeUserConstraintSetPivotInB(commandHandle, jointChildPivot);
	}

	if (pycram_bullet_internalSetVector4d(jointChildFrameOrnObj, jointChildFrameOrn))
	{
...
static PyObject* pycram_bullet_removeUserConstraint(PyObject* self, PyObject* args, PyObject* keywds)
{
...
/*
static PyObject* pycram_bullet_updateUserConstraint(PyObject* self, PyObject* args, PyObject *keywds)
{
	return NULL;
}
*/

static PyObject* pycram_bullet_enableJointForceTorqueSensor(PyObject* self, PyObject* args, PyObject* keywds)
{
	int bodyUniqueId = -1;
	int jointIndex = -1;
	int enableSensor = 1;
		...
		if (seqVerticesObj)
		{
			int numVerticesSrc = PySequence_Size(seqVerticesObj);
			{
				...
				for (i = 0; i < numVerticesSrc; i++)
				{
					PyObject* vertexObj = PySequence_GetItem(seqVerticesObj, i);
					double uv[2];
					if (pycram_bullet_internalSetVector2d(vertexObj, uv))
					{
						if (uvs)
						{
	...
	if (indicesObj)
	{
		...
		if (seqIndicesObj)
		{
			int numIndicesSrc = PySequence_Size(seqIndicesObj);
			{
				...
				{
					int index = pycram_bullet_internalGetIntFromSequence(seqIndicesObj, i);
					if (indices)
					{
...
static PyObject* pycram_bullet_createCollisionShape(PyObject* self, PyObject* args, PyObject* keywds)
{
	int physicsClientId = 0;
	b3PhysicsClientHandle sm = 0;
	int shapeType = -1;
	...
	if (shapeType >= GEOM_SPHERE)
	{
		...
		if (shapeType == GEOM_BOX && halfExtentsObj)
		{
			...
			pycram_bullet_internalSetVectord(halfExtentsObj, halfExtents);
		...
		if (shapeType == GEOM_HEIGHTFIELD && fileName)
		{
			if (meshScaleObj)
			{
				pycram_bullet_internalSetVectord(meshScaleObj, meshScale);
			}
		...
		if (shapeType == GEOM_PLANE)
		{
			...
			pycram_bullet_internalSetVectord(planeNormalObj, planeNormal);
		...
		if (shapeIndex >= 0)
		{
			...
			{
				pycram_bullet_internalSetVectord(collisionFramePositionObj, collisionFramePosition);
			}

			if (collisionFrameOrientationObj)
			{
				pycram_bullet_internalSetVector4d(collisionFrameOrientationObj, collisionFrameOrientation);
			}
...
static PyObject* pycram_bullet_createCollisionShapeArray(PyObject* self, PyObject* args, PyObject* keywds)
{
	int physicsClientId = 0;
	b3PhysicsClientHandle sm = 0;
	b3SharedMemoryStatusHandle statusHandle;
...

	{
		...
		{
			int shapeType = pycram_bullet_internalGetIntFromSequence(shapeTypeArraySeq, s);
			if (shapeType >= GEOM_SPHERE)
			{
				int shapeIndex = -1;
				...
				{
					double radius = pycram_bullet_internalGetFloatFromSequence(radiusArraySeq, s);
					if (radius > 0)
					{
						shapeIndex = b3CreateCollisionShapeAddSphere(commandHandle, radius);
					}
				...
				{
					double radius = pycram_bullet_internalGetFloatFromSequence(radiusArraySeq, s);
					double height = pycram_bullet_internalGetFloatFromSequence(lengthArraySeq, s);
				...
				if (flagsArraySeq)
				{
					int flags = pycram_bullet_internalGetIntFromSequence(flagsArraySeq, s);
					b3CreateCollisionSetFlag(commandHandle, shapeIndex, flags);
				}
...
static PyObject* pycram_bullet_getMeshData(PyObject* self, PyObject* args, PyObject* keywds)
{
	int bodyUniqueId = -1;
	int linkIndex = -1;
...
static PyObject* pycram_bullet_getTetraMeshData(PyObject* self, PyObject* args, PyObject* keywds)
{
	int bodyUniqueId = -1;
	b3PhysicsClientHandle sm = 0;
	b3SharedMemoryCommandHandle command;
...
static PyObject* pycram_bullet_resetMeshData(PyObject* self, PyObject* args, PyObject* keywds)
{
	int bodyUniqueId = -1;
	b3PhysicsClientHandle sm = 0;
	b3SharedMemoryCommandHandle command;
...
static PyObject* pycram_bullet_createVisualShape(PyObject* self, PyObject* args, PyObject* keywds)
{
	int physicsClientId = 0;
	b3PhysicsClientHandle sm = 0;
	...
	if (shapeType >= GEOM_SPHERE)
	{
		...
		if (shapeIndex >= 0)
		{
			...
			{
				pycram_bullet_internalSetVectord(visualFramePositionObj, visualFramePosition);
			}

			if (visualFrameOrientationObj)
			{
				pycram_bullet_internalSetVector4d(visualFrameOrientationObj, visualFrameOrientation);
			}
...
static PyObject* pycram_bullet_createVisualShapeArray(PyObject* self, PyObject* args, PyObject* keywds)
{
	int physicsClientId = 0;
	b3PhysicsClientHandle sm = 0;
	b3SharedMemoryStatusHandle statusHandle;
...
static PyObject* pycram_bullet_createMultiBody(PyObject* self, PyObject* args, PyObject* keywds)
{
	int physicsClientId = 0;
	b3PhysicsClientHandle sm = 0;
	double baseMass = 0;
...

	{
			...
			(numLinkMasses == numLinkInertialFrameOrientations))
		{
			...
			int baseIndex;
			pycram_bullet_internalSetVectord(basePosObj, basePosition);
			pycram_bullet_internalSetVector4d(baseOrnObj, baseOrientation);
			pycram_bullet_internalSetVectord(baseInertialFramePositionObj, baseInertialFramePosition);
			pycram_bullet_internalSetVector4d(baseInertialFrameOrientationObj, baseInertialFrameOrientation);
			...
			if (numBatchPositions > 0)
			{
				...
				{
					pycram_bullet_internalGetVector3FromSequence(seqBatchPositions, i, &batchPositions[3 * i]);
				}
			...
			{
				double linkMass = pycram_bullet_internalGetFloatFromSequence(seqLinkMasses, i);
				int linkCollisionShapeIndex = pycram_bullet_internalGetIntFromSequence(seqLinkCollisionShapes, i);
				int linkVisualShapeIndex = pycram_bullet_internalGetIntFromSequence(seqLinkVisualShapes, i);
				...
				pycram_bullet_internalGetVector3FromSequence(seqLinkInertialFramePositions, i, linkInertialFramePosition);
				pycram_bullet_internalGetVector4FromSequence(seqLinkInertialFrameOrientations, i, linkInertialFrameOrientation);
				pycram_bullet_internalGetVector3FromSequence(seqLinkPositions, i, linkPosition);
				pycram_bullet_internalGetVector4FromSequence(seqLinkOrientations, i, linkOrientation);
				pycram_bullet_internalGetVector3FromSequence(seqLinkJoinAxis, i, linkJointAxis);
				linkParentIndex = pycram_bullet_internalGetIntFromSequence(seqLinkParentIndices, i);
				linkJointType = pycram_bullet_internalGetIntFromSequence(seqLinkJointTypes, i);
...
static PyObject* pycram_bullet_createUserConstraint(PyObject* self, PyObject* args, PyObject* keywds)
{
	b3SharedMemoryCommandHandle commandHandle;
	...
	pycram_bullet_internalSetVectord(jointAxisObj, jointAxis);
	pycram_bullet_internalSetVectord(parentFramePositionObj, parentFramePosition);
	pycram_bullet_internalSetVectord(childFramePositionObj, childFramePosition);
	pycram_bullet_internalSetVector4d(parentFrameOrientationObj, parentFrameOrientation);
	pycram_bullet_internalSetVector4d(childFrameOrientationObj, childFrameOrientation);
...
static PyObject* pycram_bullet_getContactPointData(PyObject* self, PyObject* args, PyObject* keywds)
{
	int bodyUniqueIdA = -1;
	int bodyUniqueIdB = -1;
	int linkIndexA = -2;
...
static PyObject* pycram_bullet_isNumpyEnabled(PyObject* self, PyObject* args, PyObject* keywds)
{
	int physicsClientId = 0;
...
static PyObject* pycram_bullet_getCameraImage(PyObject* self, PyObject* args, PyObject* keywds)
{
	...
	if (objViewMat && objProjMat && pycram_bullet_internalSetMatrix(objViewMat, viewMatrix) && (pycram_bullet_internalSetMatrix(objProjMat, projectionMatrix)))
	{
		b3RequestCameraImageSetCameraMatrices(command, viewMatrix, projectionMatrix);
	}
	//set light direction only if function succeeds
	if (lightDirObj && pycram_bullet_internalSetVector(lightDirObj, lightDir))
	{
		b3RequestCameraImageSetLightDirection(command, lightDir);
	}
	//set light color only if function succeeds
	if (pycram_bullet_internalSetVector(lightColorObj, lightColor))
	{
	...
	if (objProjectiveTextureView && objProjectiveTextureProj && pycram_bullet_internalSetMatrix(objProjectiveTextureView, projectiveTextureView) && (pycram_bullet_internalSetMatrix(objProjectiveTextureProj, projectiveTextureProj)))
	{
...
static PyObject* pycram_bullet_computeViewMatrix(PyObject* self, PyObject* args, PyObject* keywds)
{
	...
	if (pycram_bullet_internalSetVector(camEyeObj, camEye) &&
		pycram_bullet_internalSetVector(camTargetPositionObj, camTargetPosition) &&
		pycram_bullet_internalSetVector(camUpVectorObj, camUpVector))
	{
		float viewMatrix[16];
		PyObject* pyResultList = 0;
		int i;
...
static PyObject* pycram_bullet_computeViewMatrixFromYawPitchRoll(PyObject* self, PyObject* args, PyObject* keywds)
{
	...
	if (!pycram_bullet_internalSetVector(cameraTargetPositionObj, cameraTargetPosition))
	{
...
static PyObject* pycram_bullet_computeProjectionMatrix(PyObject* self, PyObject* args, PyObject* keywds)
{
	PyObject* pyResultList = 0;
	float left;
	float right;
...
static PyObject* pycram_bullet_computeProjectionMatrixFOV(PyObject* self, PyObject* args, PyObject* keywds)
{
...
static PyObject* pycram_bullet_renderImageObsolete(PyObject* self, PyObject* args)
{
	...
	else if (size == 4)  // set camera resolution and view and projection matrix
	{
							 ...
							 &objProjMat))
		{
			...
			// set camera matrices only if set matrix function succeeds
			if (pycram_bullet_internalSetMatrix(objViewMat, viewMatrix) &&
				(pycram_bullet_internalSetMatrix(objProjMat, projectionMatrix)))
			{
						 ...
						 // calculate projection using near/far values.
	{
		...
		{
			b3RequestCameraImageSetPixelResolution(command, width, height);
			if (pycram_bullet_internalSetVector(objCameraPos, cameraPos) &&
				pycram_bullet_internalSetVector(objTargetPos, targetPos) &&
				pycram_bullet_internalSetVector(objCameraUp, cameraUp))
			{
	...
	else if (size == 11)
	{
		...
		{
			b3RequestCameraImageSetPixelResolution(command, width, height);
			if (pycram_bullet_internalSetVector(objTargetPos, targetPos))
			{
...
static PyObject* pycram_bullet_applyExternalForce(PyObject* self, PyObject* args, PyObject* keywds)
{
	{
		...
		}
		{
			...
			if (len == 3)
			{
				for (i = 0; i < 3; i++)
				{
					force[i] = pycram_bullet_internalGetFloatFromSequence(seq, i);
				}
			}
			else
			{
		...
		}
		{
			...
			if (len == 3)
			{
				for (i = 0; i < 3; i++)
				{
					position[i] = pycram_bullet_internalGetFloatFromSequence(seq, i);
				}
			}
			else
			{
...
static PyObject* pycram_bullet_applyExternalTorque(PyObject* self, PyObject* args, PyObject* keywds)
{
	{
...

		{
			...
			if (len == 3)
			{
				for (i = 0; i < 3; i++)
				{
					torque[i] = pycram_bullet_internalGetFloatFromSequence(seq, i);
				}
			}
			else
			{
...
static PyObject* pycram_bullet_getQuaternionFromEuler(PyObject* self,
												 PyObject* args, PyObject* keywds)
{
	double rpy[3];
	...
	if (eulerObj)
	{
		...
		if (len == 3)
		{
			for (i = 0; i < 3; i++)
			{
				rpy[i] = pycram_bullet_internalGetFloatFromSequence(seq, i);
			}
		}
		else
		{
...
static PyObject* pycram_bullet_multiplyTransforms(PyObject* self,
											 PyObject* args, PyObject* keywds)
{
	PyObject* posAObj = 0;
	PyObject* ornAObj = 0;
	...
	hasPosA = pycram_bullet_internalSetVectord(posAObj, posA);
	hasOrnA = pycram_bullet_internalSetVector4d(ornAObj, ornA);
	hasPosB = pycram_bullet_internalSetVectord(posBObj, posB);
	hasOrnB = pycram_bullet_internalSetVector4d(ornBObj, ornB);
...
static PyObject* pycram_bullet_invertTransform(PyObject* self,
										  PyObject* args, PyObject* keywds)
{
	PyObject* posObj = 0;
	PyObject* ornObj = 0;
	...
	hasPos = pycram_bullet_internalSetVectord(posObj, pos);
	hasOrn = pycram_bullet_internalSetVector4d(ornObj, orn);
...
static PyObject* pycram_bullet_rotateVector(PyObject* self, PyObject* args, PyObject* keywds)
{
	PyObject* quatObj;
	PyObject* vectorObj;
	double quat[4];
	...
	if (quatObj)
	{
		hasQuat = pycram_bullet_internalSetVector4d(quatObj, quat);
	}

	if (vectorObj)
	{
		hasVec = pycram_bullet_internalSetVectord(vectorObj, vec);
	}
	if (hasQuat && hasVec)
	{
		double vecOut[3];
...
static PyObject* pycram_bullet_calculateVelocityQuaternion(PyObject* self, PyObject* args, PyObject* keywds)
{
	...
	if (quatStartObj)
	{
		hasQuatStart = pycram_bullet_internalSetVector4d(quatStartObj, quatStart);
	}

	if (quatEndObj)
	{
		hasQuatEnd = pycram_bullet_internalSetVector4d(quatEndObj, quatEnd);
	}
...
static PyObject* pycram_bullet_getQuaternionSlerp(PyObject* self, PyObject* args, PyObject* keywds)
{
	PyObject* quatStartObj;
	PyObject* quatEndObj;
	double quatStart[4];
...
static PyObject* pycram_bullet_getAxisAngleFromQuaternion(PyObject* self, PyObject* args, PyObject* keywds)
{
	int physicsClientId = 0;
	PyObject* quatObj;
	double quat[4];
...
static PyObject* pycram_bullet_getQuaternionFromAxisAngle(PyObject* self, PyObject* args, PyObject* keywds)
{
	PyObject* axisObj;
	double axis[3];
	double angle;
	...
	if (axisObj)
	{
		hasAxis = pycram_bullet_internalSetVectord(axisObj, axis);
	}
...
static PyObject* pycram_bullet_getAxisDifferenceQuaternion(PyObject* self, PyObject* args, PyObject* keywds)
{
	PyObject* quatStartObj;
	PyObject* quatEndObj;
	double quatStart[4];
...
static PyObject* pycram_bullet_getDifferenceQuaternion(PyObject* self, PyObject* args, PyObject* keywds)
{
	PyObject* quatStartObj;
	PyObject* quatEndObj;
	double quatStart[4];
...
static PyObject* pycram_bullet_getEulerFromQuaternion(PyObject* self,
												 PyObject* args, PyObject* keywds)
{
	double squ;
	double sqx;
	...
	if (quatObj)
	{
		...
		if (len == 4)
		{
			for (i = 0; i < 4; i++)
			{
				quat[i] = pycram_bullet_internalGetFloatFromSequence(seq, i);
			}
		}
		else
		{
...
static PyObject* pycram_bullet_loadPlugin(PyObject* self,
									 PyObject* args, PyObject* keywds)
{
	int physicsClientId = 0;
...
static PyObject* pycram_bullet_unloadPlugin(PyObject* self,
									   PyObject* args, PyObject* keywds)
{
	int physicsClientId = 0;
...
static PyObject* pycram_bullet_executePluginCommand(PyObject* self,
											   PyObject* args, PyObject* keywds)
{
	int physicsClientId = 0;
	int pluginUniqueId = -1;
...

	{
		...
		{
			int val = pycram_bullet_internalGetIntFromSequence(seqIntArgs, i);
			b3CustomCommandExecuteAddIntArgument(command, val);
		}

		for (i = 0; i < numFloatArgs; i++)
		{
			float val = pycram_bullet_internalGetFloatFromSequence(seqFloatArgs, i);
...
static PyObject* pycram_bullet_calculateInverseKinematics(PyObject* self,
													 PyObject* args, PyObject* keywds)

{
	...
	}
	{
		...
		int hasPos = pycram_bullet_internalSetVectord(targetPosObj, pos);
		int hasOrn = pycram_bullet_internalSetVector4d(targetOrnObj, ori);
			...
			(szJointRanges == dofCount) && (szRestPoses == dofCount))
		{
			...
			{
				lowerLimits[i] = pycram_bullet_internalGetFloatFromSequence(lowerLimitsObj, i);
				upperLimits[i] = pycram_bullet_internalGetFloatFromSequence(upperLimitsObj, i);
				jointRanges[i] = pycram_bullet_internalGetFloatFromSequence(jointRangesObj, i);
				restPoses[i] = pycram_bullet_internalGetFloatFromSequence(restPosesObj, i);
			}
			hasNullSpace = 1;
		}
		...
		if (szCurrentPositions > 0)
		{
			...
			else
			{
				...
				{
					currentPositions[i] = pycram_bullet_internalGetFloatFromSequence(currentPositionsObj, i);
				}
		...
		if (szJointDamping > 0)
		{
			...
			else
			{
				...
				{
					jointDamping[i] = pycram_bullet_internalGetFloatFromSequence(jointDampingObj, i);
				}
				hasJointDamping = 1;
			}
		}
...
///Inverse Kinematics binding
static PyObject* pycram_bullet_calculateInverseKinematics2(PyObject* self,
	PyObject* args, PyObject* keywds)

{
	...
	}
	{
		...
		
		{
			...
			int hasOrn = 0;// pycram_bullet_internalSetVector4d(targetOrnObj, ori);
...
static PyObject* pycram_bullet_calculateInverseDynamics(PyObject* self, PyObject* args, PyObject* keywds)
{
	{
		int bodyUniqueId;
...

		{
			...
			if (szObVel == szObAcc)
			{
				...
				{
					jointPositionsQ[i] =
						pycram_bullet_internalGetFloatFromSequence(objPositionsQ, i);
				}
				for (i = 0; i < szObVel; i++)
				{
					jointVelocitiesQdot[i] =
						pycram_bullet_internalGetFloatFromSequence(objVelocitiesQdot, i);
					jointAccelerations[i] =
						pycram_bullet_internalGetFloatFromSequence(objAccelerations, i);
				}
...
static PyObject* pycram_bullet_calculateJacobian(PyObject* self, PyObject* args, PyObject* keywds)
{
	{
		int bodyUniqueId;
		int linkIndex;
...

		{
			...
			for (j = 0; j < numJoints; j++)
			{
				...
				switch (info.m_jointType)
				{
					...
					{
						PyErr_SetString(SpamError,
										"Spherirical joints are not supported in the pycram_bullet binding");
						return NULL;
					}
					case ePlanarType:
					{
						PyErr_SetString(SpamError,
										"Planar joints are not supported in the pycram_bullet binding");
						return NULL;
					}
					default:
					{
				...
				(szObVel == dofCountOrg) && (szObAcc == dofCountOrg))
			{
				...
				pycram_bullet_internalSetVectord(localPosition, localPoint);
				for (i = 0; i < dofCountOrg; i++)
				{
					jointPositions[i] =
						pycram_bullet_internalGetFloatFromSequence(objPositions, i);
					jointVelocities[i] =
						pycram_bullet_internalGetFloatFromSequence(objVelocities, i);
					jointAccelerations[i] =
						pycram_bullet_internalGetFloatFromSequence(objAccelerations, i);
				}
				{
...
/// Given an object id, joint positions, joint velocities and joint
/// accelerations, compute the Jacobian
static PyObject* pycram_bullet_calculateMassMatrix(PyObject* self, PyObject* args, PyObject* keywds)
{
	{
		int bodyUniqueId;
		PyObject* objPositions;
...
static PyMethodDef SpamMethods[] = {
	...
	{"connect", (PyCFunction)pycram_bullet_connectPhysicsServer, METH_VARARGS | METH_KEYWORDS,
	 "connect(method, key=SHARED_MEMORY_KEY, options='')\n"
	 "connect(method, hostname='localhost', port=1234, options='')\n"
	 "Connect to an existing physics server (using shared memory by default)."},

	{"disconnect", (PyCFunction)pycram_bullet_disconnectPhysicsServer, METH_VARARGS | METH_KEYWORDS,
	 "disconnect(physicsClientId=0)\n"
	 "Disconnect from the physics server."},

	{"getConnectionInfo", (PyCFunction)pycram_bullet_getConnectionInfo, METH_VARARGS | METH_KEYWORDS,
	 "getConnectionInfo(physicsClientId=0)\n"
	 "Return if a given client id is connected, and using what method."},

	{"isConnected", (PyCFunction)pycram_bullet_isConnected, METH_VARARGS | METH_KEYWORDS,
	 "isConnected(physicsClientId=0)\n"
	 "Return if a given client id is connected."},

	{"resetSimulation", (PyCFunction)pycram_bullet_resetSimulation, METH_VARARGS | METH_KEYWORDS,
	 "resetSimulation(physicsClientId=0)\n"
	 "Reset the simulation: remove all objects and start from an empty world."},
	
	{"stepSimulation", (PyCFunction)pycram_bullet_stepSimulation, METH_VARARGS | METH_KEYWORDS,
	 "stepSimulation(physicsClientId=0)\n"
	 "Step the simulation using forward dynamics."},

	{"performCollisionDetection", (PyCFunction)pycram_bullet_performCollisionDetection, METH_VARARGS | METH_KEYWORDS,
	...
	{"setGravity", (PyCFunction)pycram_bullet_setGravity, METH_VARARGS | METH_KEYWORDS,
	 "setGravity(gravX, gravY, gravZ, physicsClientId=0)\n"
	 "Set the gravity acceleration (x,y,z)."},

	{"setTimeStep", (PyCFunction)pycram_bullet_setTimeStep, METH_VARARGS | METH_KEYWORDS,
	...
	{"setDefaultContactERP", (PyCFunction)pycram_bullet_setDefaultContactERP, METH_VARARGS | METH_KEYWORDS,
	...
	{"setRealTimeSimulation", (PyCFunction)pycram_bullet_setRealTimeSimulation, METH_VARARGS | METH_KEYWORDS,
	...
	{"setPhysicsEngineParameter", (PyCFunction)pycram_bullet_setPhysicsEngineParameter, METH_VARARGS | METH_KEYWORDS,
	 "Set some internal physics engine parameter, such as cfm or erp etc."},

	{"getPhysicsEngineParameters", (PyCFunction)pycram_bullet_getPhysicsEngineParameters, METH_VARARGS | METH_KEYWORDS,
	 "Get the current values of internal physics engine parameters"},

	{"setInternalSimFlags", (PyCFunction)pycram_bullet_setInternalSimFlags, METH_VARARGS | METH_KEYWORDS,
	 "This is for experimental purposes, use at own risk, magic may or not happen"},

	{"loadURDF", (PyCFunction)pycram_bullet_loadURDF, METH_VARARGS | METH_KEYWORDS,
	...
	{"loadSDF", (PyCFunction)pycram_bullet_loadSDF, METH_VARARGS | METH_KEYWORDS,
	 "Load multibodies from an SDF file."},
#ifndef SKIP_SOFT_BODY_MULTI_BODY_DYNAMICS_WORLD
	{"loadSoftBody", (PyCFunction)pycram_bullet_loadSoftBody, METH_VARARGS | METH_KEYWORDS,
	 "Load a softbody from an obj file."},

	{"createSoftBodyAnchor", (PyCFunction)pycram_bullet_createSoftBodyAnchor, METH_VARARGS | METH_KEYWORDS,
	 "Create an anchor (attachment) between a soft body and a rigid or multi body."},

#endif
	{"loadBullet", (PyCFunction)pycram_bullet_loadBullet, METH_VARARGS | METH_KEYWORDS,
	 "Load a world from a .bullet file."},

	{"saveBullet", (PyCFunction)pycram_bullet_saveBullet, METH_VARARGS | METH_KEYWORDS,
	 "Save the full state of the world to a .bullet file."},

	{"restoreState", (PyCFunction)pycram_bullet_restoreState, METH_VARARGS | METH_KEYWORDS,
	 "Restore the full state of an existing world."},

	{"saveState", (PyCFunction)pycram_bullet_saveState, METH_VARARGS | METH_KEYWORDS,
	 "Save the full state of the world to memory."},

	 { "removeState", (PyCFunction)pycram_bullet_removeState, METH_VARARGS | METH_KEYWORDS,
	"Remove a state created using saveState by its state unique id." },

	{"loadMJCF", (PyCFunction)pycram_bullet_loadMJCF, METH_VARARGS | METH_KEYWORDS,
	 "Load multibodies from an MJCF file."},

	{"createCollisionShape", (PyCFunction)pycram_bullet_createCollisionShape, METH_VARARGS | METH_KEYWORDS,
	 "Create a collision shape. Returns a non-negative (int) unique id, if successfull, negative otherwise."},

	{"createCollisionShapeArray", (PyCFunction)pycram_bullet_createCollisionShapeArray, METH_VARARGS | METH_KEYWORDS,
	 "Create collision shapes. Returns a non-negative (int) unique id, if successfull, negative otherwise."},

	{"removeCollisionShape", (PyCFunction)pycram_bullet_removeCollisionShape, METH_VARARGS | METH_KEYWORDS,
	 "Remove a collision shape. Only useful when the collision shape is not used in a body (to perform a getClosestPoint query)."},

	{"getMeshData", (PyCFunction)pycram_bullet_getMeshData, METH_VARARGS | METH_KEYWORDS,
	 "Get mesh data. Returns vertices etc from the mesh."},

	{"getTetraMeshData", (PyCFunction)pycram_bullet_getTetraMeshData, METH_VARARGS | METH_KEYWORDS,
	 "Get mesh data. Returns tetra from the mesh."},

	{"resetMeshData", (PyCFunction)pycram_bullet_resetMeshData, METH_VARARGS | METH_KEYWORDS,
	 "Reset mesh data. Only implemented for deformable bodies."},

	{"createVisualShape", (PyCFunction)pycram_bullet_createVisualShape, METH_VARARGS | METH_KEYWORDS,
	 "Create a visual shape. Returns a non-negative (int) unique id, if successfull, negative otherwise."},

	{"createVisualShapeArray", (PyCFunction)pycram_bullet_createVisualShapeArray, METH_VARARGS | METH_KEYWORDS,
	 "Create visual shapes. Returns a non-negative (int) unique id, if successfull, negative otherwise."},

	{"createMultiBody", (PyCFunction)pycram_bullet_createMultiBody, METH_VARARGS | METH_KEYWORDS,
	 "Create a multi body. Returns a non-negative (int) unique id, if successfull, negative otherwise."},

	{"createConstraint", (PyCFunction)pycram_bullet_createUserConstraint, METH_VARARGS | METH_KEYWORDS,
	 "Create a constraint between two bodies. Returns a (int) unique id, if successfull."},

	{"changeConstraint", (PyCFunction)pycram_bullet_changeUserConstraint, METH_VARARGS | METH_KEYWORDS,
	 "Change some parameters of an existing constraint, such as the child pivot or child frame orientation, using its unique id."},

	{"removeConstraint", (PyCFunction)pycram_bullet_removeUserConstraint, METH_VARARGS | METH_KEYWORDS,
	 "Remove a constraint using its unique id."},

	{"enableJointForceTorqueSensor", (PyCFunction)pycram_bullet_enableJointForceTorqueSensor, METH_VARARGS | METH_KEYWORDS,
	 "Enable or disable a joint force/torque sensor measuring the joint reaction forces."},

	{"saveWorld", (PyCFunction)pycram_bullet_saveWorld, METH_VARARGS | METH_KEYWORDS,
	...
	{"getNumBodies", (PyCFunction)pycram_bullet_getNumBodies, METH_VARARGS | METH_KEYWORDS,
	 "Get the number of bodies in the simulation."},

	{"getBodyUniqueId", (PyCFunction)pycram_bullet_getBodyUniqueId, METH_VARARGS | METH_KEYWORDS,
	...
	{"getBodyInfo", (PyCFunction)pycram_bullet_getBodyInfo, METH_VARARGS | METH_KEYWORDS,
	 "Get the body info, given a body unique id."},

	{ "computeDofCount", (PyCFunction)pycram_bullet_computeDofCount, METH_VARARGS | METH_KEYWORDS,
	...
	{"syncBodyInfo", (PyCFunction)pycram_bullet_syncBodyInfo, METH_VARARGS | METH_KEYWORDS,
	 "syncBodyInfo(physicsClientId=0)\n"
	 "Update body and constraint/joint information, in case other clients made changes."},

	{"syncUserData", (PyCFunction)pycram_bullet_syncUserData, METH_VARARGS | METH_KEYWORDS,
	 "syncUserData(bodyUniqueIds=[], physicsClientId=0)\n"
	 "Update user data, in case other clients made changes."},

	{"addUserData", (PyCFunction)pycram_bullet_addUserData, METH_VARARGS | METH_KEYWORDS,
	...
	{"getUserData", (PyCFunction)pycram_bullet_getUserData, METH_VARARGS | METH_KEYWORDS,
	 "getUserData(userDataId, physicsClientId=0)\n"
	 "Returns the user data value."},

	{"removeUserData", (PyCFunction)pycram_bullet_removeUserData, METH_VARARGS | METH_KEYWORDS,
	 "removeUserData(userDataId, physicsClientId=0)\n"
	 "Removes a user data entry."},

	{"getUserDataId", (PyCFunction)pycram_bullet_getUserDataId, METH_VARARGS | METH_KEYWORDS,
	...
	{"getNumUserData", (PyCFunction)pycram_bullet_getNumUserData, METH_VARARGS | METH_KEYWORDS,
	 "getNumUserData(bodyUniqueId physicsClientId=0)\n"
	 "Retrieves the number of user data entries in a body."},

	{"getUserDataInfo", (PyCFunction)pycram_bullet_getUserDataInfo, METH_VARARGS | METH_KEYWORDS,
	...
	{"removeBody", (PyCFunction)pycram_bullet_removeBody, METH_VARARGS | METH_KEYWORDS,
	 "Remove a body by its body unique id."},

	{"getNumConstraints", (PyCFunction)pycram_bullet_getNumConstraints, METH_VARARGS | METH_KEYWORDS,
	 "Get the number of user-created constraints in the simulation."},

	{"getConstraintInfo", (PyCFunction)pycram_bullet_getConstraintInfo, METH_VARARGS | METH_KEYWORDS,
	 "Get the user-created constraint info, given a constraint unique id."},

	{"getConstraintState", (PyCFunction)pycram_bullet_getConstraintState, METH_VARARGS | METH_KEYWORDS,
	 "Get the user-created constraint state (applied forces), given a constraint unique id."},

	{"getConstraintUniqueId", (PyCFunction)pycram_bullet_getConstraintUniqueId, METH_VARARGS | METH_KEYWORDS,
	 "Get the unique id of the constraint, given a integer index in range [0.. number of constraints)."},

	{"getBasePositionAndOrientation", (PyCFunction)pycram_bullet_getBasePositionAndOrientation,
	...
	{"getAABB", (PyCFunction)pycram_bullet_getAABB,
	 METH_VARARGS | METH_KEYWORDS,
	 "Get the axis aligned bound box min and max coordinates in world space."},

	{"resetBasePositionAndOrientation",
	 (PyCFunction)pycram_bullet_resetBasePositionAndOrientation, METH_VARARGS | METH_KEYWORDS,
	...
	{ "unsupportedChangeScaling",
	 (PyCFunction)pycram_bullet_changeScaling, METH_VARARGS | METH_KEYWORDS,
	 "Change the scaling of the base of an object."	 
	 "Warning: unsupported rudimentary feature that has many limitations."
	 },

	{"getBaseVelocity", (PyCFunction)pycram_bullet_getBaseVelocity,
	 METH_VARARGS | METH_KEYWORDS,
	...
	{"resetBaseVelocity", (PyCFunction)pycram_bullet_resetBaseVelocity, METH_VARARGS | METH_KEYWORDS,
	 "Reset the linear and/or angular velocity of the base of the object "
	 " in world space coordinates. "
	 "linearVelocity (x,y,z) and angularVelocity (x,y,z)."},

	{"getNumJoints", (PyCFunction)pycram_bullet_getNumJoints, METH_VARARGS | METH_KEYWORDS,
	 "Get the number of joints for an object."},

	{"getJointInfo", (PyCFunction)pycram_bullet_getJointInfo, METH_VARARGS | METH_KEYWORDS,
	 "Get the name and type info for a joint on a body."},

	{"getJointState", (PyCFunction)pycram_bullet_getJointState, METH_VARARGS | METH_KEYWORDS,
	 "Get the state (position, velocity etc) for a joint on a body."},

	{"getJointStates", (PyCFunction)pycram_bullet_getJointStates, METH_VARARGS | METH_KEYWORDS,
	 "Get the state (position, velocity etc) for multiple joints on a body."},

	 { "getJointStateMultiDof", (PyCFunction)pycram_bullet_getJointStateMultiDof, METH_VARARGS | METH_KEYWORDS,
		"Get the state (position, velocity etc) for a joint on a body. (supports planar and spherical joints)" },

	{ "getJointStatesMultiDof", (PyCFunction)pycram_bullet_getJointStatesMultiDof, METH_VARARGS | METH_KEYWORDS,
		 "Get the states (position, velocity etc) for multiple joint on a body. (supports planar and spherical joints)" },


	{"getLinkState", (PyCFunction)pycram_bullet_getLinkState, METH_VARARGS | METH_KEYWORDS,
	 ...
	 { "getLinkStates", (PyCFunction)pycram_bullet_getLinkStates, METH_VARARGS | METH_KEYWORDS,
	"same as getLinkState except it takes a list of linkIndices" },

	{"resetJointState", (PyCFunction)pycram_bullet_resetJointState, METH_VARARGS | METH_KEYWORDS,
	 "resetJointState(objectUniqueId, jointIndex, targetValue, targetVelocity=0, physicsClientId=0)\n"
	 "Reset the state (position, velocity etc) for a joint on a body "
	 "instantaneously, not through physics simulation."},

	{"resetJointStateMultiDof", (PyCFunction)pycram_bullet_resetJointStateMultiDof, METH_VARARGS | METH_KEYWORDS,
	 "resetJointStateMultiDof(objectUniqueId, jointIndex, targetValue, targetVelocity=0, physicsClientId=0)\n"
	 "Reset the state (position, velocity etc) for a joint on a body "
	 "instantaneously, not through physics simulation."},
	 { "resetJointStatesMultiDof", (PyCFunction)pycram_bullet_resetJointStatesMultiDof, METH_VARARGS | METH_KEYWORDS,
	...
	{"changeDynamics", (PyCFunction)pycram_bullet_changeDynamicsInfo, METH_VARARGS | METH_KEYWORDS,
	 "change dynamics information such as mass, lateral friction coefficient."},

	{"getDynamicsInfo", (PyCFunction)pycram_bullet_getDynamicsInfo, METH_VARARGS | METH_KEYWORDS,
	 "Get dynamics information such as mass, lateral friction coefficient."},

	{"setJointMotorControl", (PyCFunction)pycram_bullet_setJointMotorControl, METH_VARARGS,
	...
	{"setJointMotorControl2", (PyCFunction)pycram_bullet_setJointMotorControl2, METH_VARARGS | METH_KEYWORDS,
	 "Set a single joint motor control mode and desired target value. There is "
	 "no immediate state change, stepSimulation will process the motors."},

	{"setJointMotorControlMultiDof", (PyCFunction)pycram_bullet_setJointMotorControlMultiDof, METH_VARARGS | METH_KEYWORDS,
	 "Set a single joint motor control mode and desired target value. There is "
	 "no immediate state change, stepSimulation will process the motors."
	 "This method sets multi-degree-of-freedom motor such as the spherical joint motor."},

	 { "setJointMotorControlMultiDofArray", (PyCFunction)pycram_bullet_setJointMotorControlMultiDofArray, METH_VARARGS | METH_KEYWORDS,
	...
	{"setJointMotorControlArray", (PyCFunction)pycram_bullet_setJointMotorControlArray, METH_VARARGS | METH_KEYWORDS,
	...
	{"applyExternalForce", (PyCFunction)pycram_bullet_applyExternalForce, METH_VARARGS | METH_KEYWORDS,
	...
	{"applyExternalTorque", (PyCFunction)pycram_bullet_applyExternalTorque, METH_VARARGS | METH_KEYWORDS,
	...
	{"renderImage", pycram_bullet_renderImageObsolete, METH_VARARGS,
	 "obsolete, please use getCameraImage and getViewProjectionMatrices instead"},

	{"getCameraImage", (PyCFunction)pycram_bullet_getCameraImage, METH_VARARGS | METH_KEYWORDS,
	...
	{"isNumpyEnabled", (PyCFunction)pycram_bullet_isNumpyEnabled, METH_VARARGS | METH_KEYWORDS,
	 "return True if PyBullet was compiled with NUMPY support. This makes the getCameraImage API faster"},

	{"computeViewMatrix", (PyCFunction)pycram_bullet_computeViewMatrix, METH_VARARGS | METH_KEYWORDS,
	 "Compute a camera viewmatrix from camera eye,  target position and up vector "},

	{"computeViewMatrixFromYawPitchRoll", (PyCFunction)pycram_bullet_computeViewMatrixFromYawPitchRoll, METH_VARARGS | METH_KEYWORDS,
	 "Compute a camera viewmatrix from camera eye,  target position and up vector "},

	{"computeProjectionMatrix", (PyCFunction)pycram_bullet_computeProjectionMatrix, METH_VARARGS | METH_KEYWORDS,
	 "Compute a camera projection matrix from screen left/right/bottom/top/near/far values"},

	{"computeProjectionMatrixFOV", (PyCFunction)pycram_bullet_computeProjectionMatrixFOV, METH_VARARGS | METH_KEYWORDS,
	 "Compute a camera projection matrix from fov, aspect ratio, near, far values"},

	{"getContactPoints", (PyCFunction)pycram_bullet_getContactPointData, METH_VARARGS | METH_KEYWORDS,
	...
	{"getClosestPoints", (PyCFunction)pycram_bullet_getClosestPointData, METH_VARARGS | METH_KEYWORDS,
	...
	{"getOverlappingObjects", (PyCFunction)pycram_bullet_getOverlappingObjects, METH_VARARGS | METH_KEYWORDS,
	...
	{"setCollisionFilterPair", (PyCFunction)pycram_bullet_setCollisionFilterPair, METH_VARARGS | METH_KEYWORDS,
	...
	{"setCollisionFilterGroupMask", (PyCFunction)pycram_bullet_setCollisionFilterGroupMask, METH_VARARGS | METH_KEYWORDS,
	 "Set the collision filter group and the mask for a body."},

	{"addUserDebugLine", (PyCFunction)pycram_bullet_addUserDebugLine, METH_VARARGS | METH_KEYWORDS,
	...
	{"addUserDebugPoints", (PyCFunction)pycram_bullet_addUserDebugPoints, METH_VARARGS | METH_KEYWORDS,
	 "Add user debug draw points with pointPositions[3], pointColorsRGB[3], pointSize, lifeTime. "
	 "A lifeTime of 0 means permanent until removed. Returns a unique id for the user debug item."},

	{"addUserDebugText", (PyCFunction)pycram_bullet_addUserDebugText, METH_VARARGS | METH_KEYWORDS,
	 "Add a user debug draw line with text, textPosition[3], textSize and lifeTime in seconds "
	 "A lifeTime of 0 means permanent until removed. Returns a unique id for the user debug item."},

	{"addUserDebugParameter", (PyCFunction)pycram_bullet_addUserDebugParameter, METH_VARARGS | METH_KEYWORDS,
	 "Add a user debug parameter, such as a slider, that can be controlled using a GUI."},
	{"readUserDebugParameter", (PyCFunction)pycram_bullet_readUserDebugParameter, METH_VARARGS | METH_KEYWORDS,
	 "Read the current value of a user debug parameter, given the user debug item unique id."},

	{"removeUserDebugItem", (PyCFunction)pycram_bullet_removeUserDebugItem, METH_VARARGS | METH_KEYWORDS,
	 "remove a user debug draw item, giving its unique id"},

	{"removeAllUserDebugItems", (PyCFunction)pycram_bullet_removeAllUserDebugItems, METH_VARARGS | METH_KEYWORDS,
	 "remove all user debug draw items"},

	 { "removeAllUserParameters", (PyCFunction)pycram_bullet_removeAllUserParameters, METH_VARARGS | METH_KEYWORDS,
		 "remove all user debug parameters (sliders, buttons)" },

	{"setDebugObjectColor", (PyCFunction)pycram_bullet_setDebugObjectColor, METH_VARARGS | METH_KEYWORDS,
	...
	{"getDebugVisualizerCamera", (PyCFunction)pycram_bullet_getDebugVisualizerCamera, METH_VARARGS | METH_KEYWORDS,
	 "Get information about the 3D visualizer camera, such as width, height, view matrix, projection matrix etc."},

	{"configureDebugVisualizer", (PyCFunction)pycram_bullet_configureDebugVisualizer, METH_VARARGS | METH_KEYWORDS,
	 "For the 3D OpenGL Visualizer, enable/disable GUI, shadows."},

	{"resetDebugVisualizerCamera", (PyCFunction)pycram_bullet_resetDebugVisualizerCamera, METH_VARARGS | METH_KEYWORDS,
	 "For the 3D OpenGL Visualizer, set the camera distance, yaw, pitch and target position."},

	{"getVisualShapeData", (PyCFunction)pycram_bullet_getVisualShapeData, METH_VARARGS | METH_KEYWORDS,
	 "Return the visual shape information for one object."},

	{"getCollisionShapeData", (PyCFunction)pycram_bullet_getCollisionShapeData, METH_VARARGS | METH_KEYWORDS,
	 "Return the collision shape information for one object."},

	{"changeVisualShape", (PyCFunction)pycram_bullet_changeVisualShape, METH_VARARGS | METH_KEYWORDS,
	 "Change part of the visual shape information for one object."},

	{"resetVisualShapeData", (PyCFunction)pycram_bullet_changeVisualShape, METH_VARARGS | METH_KEYWORDS,
	 "Obsolete method, kept for backward compatibility, use changeVisualShapeData instead."},

	{"loadTexture", (PyCFunction)pycram_bullet_loadTexture, METH_VARARGS | METH_KEYWORDS,
	 "Load texture file."},

	{"changeTexture", (PyCFunction)pycram_bullet_changeTexture, METH_VARARGS | METH_KEYWORDS,
	 "Change a texture file."},

	{"getQuaternionFromEuler", (PyCFunction)pycram_bullet_getQuaternionFromEuler, METH_VARARGS | METH_KEYWORDS,
	 "Convert Euler [roll, pitch, yaw] as in URDF/SDF convention, to "
	 "quaternion [x,y,z,w]"},

	{"getEulerFromQuaternion", (PyCFunction)pycram_bullet_getEulerFromQuaternion, METH_VARARGS | METH_KEYWORDS,
	 "Convert quaternion [x,y,z,w] to Euler [roll, pitch, yaw] as in URDF/SDF "
	 "convention"},

	{"multiplyTransforms", (PyCFunction)pycram_bullet_multiplyTransforms, METH_VARARGS | METH_KEYWORDS,
	 "Multiply two transform, provided as [position], [quaternion]."},

	{"invertTransform", (PyCFunction)pycram_bullet_invertTransform, METH_VARARGS | METH_KEYWORDS,
	 "Invert a transform, provided as [position], [quaternion]."},

	{"getMatrixFromQuaternion", (PyCFunction)pycram_bullet_getMatrixFromQuaternion, METH_VARARGS | METH_KEYWORDS,
	 "Compute the 3x3 matrix from a quaternion, as a list of 9 values (row-major)"},

	{"getQuaternionSlerp", (PyCFunction)pycram_bullet_getQuaternionSlerp, METH_VARARGS | METH_KEYWORDS,
	 "Compute the spherical interpolation given a start and end quaternion and an interpolation value in range [0..1]"},

	{"getQuaternionFromAxisAngle", (PyCFunction)pycram_bullet_getQuaternionFromAxisAngle, METH_VARARGS | METH_KEYWORDS,
	 "Compute the quaternion from axis and angle representation."},

	{"getAxisAngleFromQuaternion", (PyCFunction)pycram_bullet_getAxisAngleFromQuaternion, METH_VARARGS | METH_KEYWORDS,
	 "Compute the quaternion from axis and angle representation."},

	{"getDifferenceQuaternion", (PyCFunction)pycram_bullet_getDifferenceQuaternion, METH_VARARGS | METH_KEYWORDS,
	 "Compute the quaternion difference from two quaternions."},

	{"getAxisDifferenceQuaternion", (PyCFunction)pycram_bullet_getAxisDifferenceQuaternion, METH_VARARGS | METH_KEYWORDS,
	 "Compute the velocity axis difference from two quaternions."},

	{"calculateVelocityQuaternion", (PyCFunction)pycram_bullet_calculateVelocityQuaternion, METH_VARARGS | METH_KEYWORDS,
	 "Compute the angular velocity given start and end quaternion and delta time."},

	{"rotateVector", (PyCFunction)pycram_bullet_rotateVector, METH_VARARGS | METH_KEYWORDS,
	 "Rotate a vector using a quaternion."},

	{"calculateInverseDynamics", (PyCFunction)pycram_bullet_calculateInverseDynamics, METH_VARARGS | METH_KEYWORDS,
	 "Given an object id, joint positions, joint velocities and joint "
	 "accelerations, compute the joint forces using Inverse Dynamics"},

	{"calculateJacobian", (PyCFunction)pycram_bullet_calculateJacobian, METH_VARARGS | METH_KEYWORDS,
	...
	{"calculateMassMatrix", (PyCFunction)pycram_bullet_calculateMassMatrix, METH_VARARGS | METH_KEYWORDS,
	...
	{"calculateInverseKinematics", (PyCFunction)pycram_bullet_calculateInverseKinematics,
	 METH_VARARGS | METH_KEYWORDS,
	 "Inverse Kinematics bindings: Given an object id, "
	 "current joint positions and target position"
	 " for the end effector,"
	 "compute the inverse kinematics and return the new joint state"},
	 { "calculateInverseKinematics2", (PyCFunction)pycram_bullet_calculateInverseKinematics2,
		METH_VARARGS | METH_KEYWORDS,
		"Inverse Kinematics bindings: Given an object id, "
	...
	{"getVREvents", (PyCFunction)pycram_bullet_getVREvents, METH_VARARGS | METH_KEYWORDS,
	 "Get Virtual Reality events, for example to track VR controllers position/buttons"},
	{"setVRCameraState", (PyCFunction)pycram_bullet_setVRCameraState, METH_VARARGS | METH_KEYWORDS,
	...
	{"getKeyboardEvents", (PyCFunction)pycram_bullet_getKeyboardEvents, METH_VARARGS | METH_KEYWORDS,
	 "Get keyboard events, keycode and state (KEY_IS_DOWN, KEY_WAS_TRIGGERED, KEY_WAS_RELEASED)"},

	{"getMouseEvents", (PyCFunction)pycram_bullet_getMouseEvents, METH_VARARGS | METH_KEYWORDS,
	 "Get mouse events, event type and button state (KEY_IS_DOWN, KEY_WAS_TRIGGERED, KEY_WAS_RELEASED)"},

	{"startStateLogging", (PyCFunction)pycram_bullet_startStateLogging, METH_VARARGS | METH_KEYWORDS,
	...
	{"stopStateLogging", (PyCFunction)pycram_bullet_stopStateLogging, METH_VARARGS | METH_KEYWORDS,
	 "Stop logging of robot state, given a loggingUniqueId."},
	{"rayTest", (PyCFunction)pycram_bullet_rayTestObsolete, METH_VARARGS | METH_KEYWORDS,
	 "Cast a ray and return the first object hit, if any. "
	 "Takes two arguments (from_position [x,y,z] and to_position [x,y,z] in Cartesian world coordinates"},

	{"rayTestBatch", (PyCFunction)pycram_bullet_rayTestBatch, METH_VARARGS | METH_KEYWORDS,
	...
	{"loadPlugin", (PyCFunction)pycram_bullet_loadPlugin, METH_VARARGS | METH_KEYWORDS,
	 "Load a plugin, could implement custom commands etc."},

	{"unloadPlugin", (PyCFunction)pycram_bullet_unloadPlugin, METH_VARARGS | METH_KEYWORDS,
	 "Unload a plugin, given the pluginUniqueId."},

	{"executePluginCommand", (PyCFunction)pycram_bullet_executePluginCommand, METH_VARARGS | METH_KEYWORDS,
	 "Execute a command, implemented in a plugin."},

	{"submitProfileTiming", (PyCFunction)pycram_bullet_submitProfileTiming, METH_VARARGS | METH_KEYWORDS,
	...
	{"setTimeOut", (PyCFunction)pycram_bullet_setTimeOut, METH_VARARGS | METH_KEYWORDS,
	 "Set the timeOut in seconds, used for most of the API calls."},

#ifdef BT_ENABLE_VHACD
	{"vhacd", (PyCFunction)pycram_bullet_vhacd, METH_VARARGS | METH_KEYWORDS,
	...
	{"getAPIVersion", (PyCFunction)pycram_bullet_getAPIVersion,
	 METH_VARARGS | METH_KEYWORDS,
...
static struct PyModuleDef moduledef = {
	PyModuleDef_HEAD_INIT, "pycram_bullet", /* m_name */
...
PyMODINIT_FUNC
#if PY_MAJOR_VERSION >= 3
PyInit_pycram_bullet(void)
#else
initpycram_bullet(void)
#endif
{
	PyObject* m;
#if PY_MAJOR_VERSION >= 3
...
#else
	m = Py_InitModule3("pycram_bullet", SpamMethods, "Python bindings for Bullet");
#endif
	...
	SpamError = PyErr_NewException("pycram_bullet.error", NULL, NULL);
	Py_INCREF(SpamError);
	PyModule_AddObject(m, "error", SpamError);
	fprintf(stderr, "pycram_bullet build time: %s %s\n", __DATE__, __TIME__);

	Py_AtExit(b3pycram_bulletExitFunc);
