...
def load_box(pycram_bullet_client: bullet_client.BulletClient,
    ...
    """
    col_box_id = pycram_bullet_client.createCollisionShape(
        pycram_bullet.GEOM_BOX, halfExtents=half_extents)
    visual_box_id = pycram_bullet_client.createVisualShape(
        pycram_bullet.GEOM_BOX, halfExtents=half_extents, rgbaColor=rgba_color)
    return pycram_bullet_client.createMultiBody(
        baseMass=mass,
...
def build_one_stepstone(
  ...
  Args:
    pycram_bullet_client: The pycram_bullet client instance.
  ...
  Returns:
    ...
    The pycram_bullet id of the stepstone.
  """
  ...
  step_stone_id = load_box(pycram_bullet_client,
...
def build_stepstones(
  ...
  Returns:
    ...
    The pycram_bullet ids of the stepstones.
  """
  end_pos = start_pos
  ids = []
