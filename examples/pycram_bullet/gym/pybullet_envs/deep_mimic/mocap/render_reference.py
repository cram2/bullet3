...
# from pycram_bullet_envs.deep_mimic.env.humanoid_stable_pd import HumanoidStablePd
...
bc = BulletClient(connection_mode=pycram_bullet.GUI)
bc.setAdditionalSearchPath(pycram_bullet_data.getDataPath())
